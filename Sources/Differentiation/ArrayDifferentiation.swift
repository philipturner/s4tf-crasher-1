...
extension Array where Element: Differentiable {
  ...
  @frozen
  public struct DifferentiableView2 {
    var _base: [Element]
  }
}

extension Array.DifferentiableView2: Differentiable
where Element: Differentiable {
  ...
  @derivative(of: base)
  func _vjpBase() -> (
    value: [Element], pullback: (Array<Element>.TangentVector) -> Array<Element.TangentVector>.DifferentiableView2.TangentVector
  ) {
    fatalError()
//    return (base, { $0 })
  }
  ...
  @derivative(of: base)
  func _jvpBase() -> (
    value: [Element], differential: (Array<Element>.DifferentiableView2.TangentVector) -> Array<Element>.TangentVector
  ) {
    fatalError()
//    return (base, { $0 })
  }
  ...
  static func _vjpInit(_ base: [Element]) -> (
    value: Array.DifferentiableView2, pullback: (Array<Element>.DifferentiableView2.TangentVector) -> Array<Element>.TangentVector
  ) {
    fatalError()
//    return (Array.DifferentiableView2(base), { $0 })
  }

  @usableFromInline
  @derivative(of: init(_:))
  static func _jvpInit(_ base: [Element]) -> (
    value: Array.DifferentiableView2, differential: (Array<Element>.TangentVector) -> Array<Element>.DifferentiableView2.TangentVector
  ) {
    fatalError()
//    return (Array.DifferentiableView2(base), { $0 })
  }
  ...
  public typealias TangentVector =
    Array<Element.TangentVector>.DifferentiableView2
...
extension Array.DifferentiableView2: Equatable
where Element: Differentiable & Equatable {
  public static func == (
    lhs: Array.DifferentiableView2,
    rhs: Array.DifferentiableView2
  ) -> Bool {
    return lhs.base == rhs.base
  }
}

extension Array.DifferentiableView2: ExpressibleByArrayLiteral
where Element: Differentiable {
...
extension Array.DifferentiableView2: CustomStringConvertible
where Element: Differentiable {
...
extension Array.DifferentiableView2: CustomReflectable {
...
/// of all counts.
extension Array.DifferentiableView2: AdditiveArithmetic
where Element: AdditiveArithmetic & Differentiable {

  public static var zero: Array.DifferentiableView2 {
    return Array.DifferentiableView2([])
  }

  public static func + (
    lhs: Array.DifferentiableView2,
    rhs: Array.DifferentiableView2
  ) -> Array.DifferentiableView2 {
    if lhs.base.count == 0 {
      return rhs
    }
    if rhs.base.count == 0 {
    ...
    return Array.DifferentiableView2(zip(lhs.base, rhs.base).map(+))
  }
